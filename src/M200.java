...
public class M200 {
    ...
    public List<String> m200Parsing(String text, String nv, String nvOwner, Fields fields){
        ...
        String mess = "200";
        String operation = "ОТПР  ";
        if(
            (textArrayItem[3].equals("7568") && textArrayItem[5].equals("7569")) ||
            (textArrayItem[3].equals("8769") && textArrayItem[5].equals("8770")) ||
            (textArrayItem[3].equals("8772") && textArrayItem[5].equals("8773")) ||
            (textArrayItem[3].equals("7561") && (textArrayItem[5].equals("7569") || textArrayItem[5].equals("7562"))) ||
            (textArrayItem[3].equals("7545") && textArrayItem[5].equals("5485"))
        ){ operation = "СДЧГ  "; }
